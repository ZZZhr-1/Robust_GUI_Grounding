...
def get_image_info(image_path, min_pixels, max_pixels):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        for _, j in enumerate(range(0, len(sources), 2)):
            ...
            if DEFAULT_IMAGE_TOKEN in user_input:
                ...
                # processed_images, resized_height, resized_width = processor.image_processor._process_p1(images=images)
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, examples):
        ...
        for example in examples:
            ...
            # batch_user_inputs.append(example["user_inputs"])
            batch_filename.append(example["image_files"])
        ...
        data_dict = {
            ...
            'labels': labels,
            'attention_mask': attention_mask,
            "filenames": batch_filename,
            "ids": batch_ids
        }

        # images = torch.cat(batch_images)
        # data_dict["images"] = batch_images

        # data_dict["user_inputs"] = batch_user_inputs
