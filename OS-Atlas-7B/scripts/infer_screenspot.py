...
for task in tasks:
    ...
    for j, item in tqdm(enumerate(screenspot_data)):
        ...
        messages = [
            {
                ...
                "content": [
                    ...
                    # {"type": "text", "text": f"In this UI screenshot, what is the position of the element corresponding to the command \"{instruction}\" (with point)?"}
                ],
            }
        ]
        ...
        # if inputs.pixel_values.shape[0] > max_num_patchs:
        #     max_num_patchs = inputs.pixel_values.shape[0]
...
with open("OS_infer_result.txt", 'a+') as f:
